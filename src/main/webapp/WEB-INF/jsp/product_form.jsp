...
<body>
    ...
    <div class="g-doc">
        ...
        <div class="n-public">
            <form class="m-form m-form-ht" id="form" method="post" action="/product/submit" onsubmit="return false;" autocomplete="off">
                <div class="fmitem">
                ...
                <div class="fmitem">
                    ...
                    <div class="fmipt">
                        <input type="number" style="width: 80px" step="1" min="1"  name="count"
                               placeholder="输入整数" data-error="请输入整数" value="1" required>
                    </div>
                </div>
                <div class="fmitem">
                    <label class="fmlab">价格：</label>
                    <div class="fmipt">
                        <input style="width: 80px" name="price"/>元
                    </div>
                </div>
